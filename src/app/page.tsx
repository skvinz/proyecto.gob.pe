    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 bg-[#fbfbfb]">
        ...
        <div className="container mx-auto px-4 py-6 md:py-8">
          ...
          <a
            href="#"
            className="text-blue-600 hover:text-blue-800 font-semibold text-base md:text-lg inline-block mb-3 md:mb-4"
          >
          ...
          {/* Divider */}
          <div className="my-8 md:my-12 border-t border-gray-300"></div>
